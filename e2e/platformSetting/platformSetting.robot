...
${URL}                          https://test.discountcar.com
...
${Applitools-url}               https://test.discountcar.com
${Applitools-AppName}           Discount_Website
${Applitools-TestName}          Discount_Test
${Applitools-Key}
${Width}                        1024
${Height}                       768
...
Open Browser To Home Page With
    ...
    Run Keyword If      '${use mobile iphone8}' == '${platform}'      IOS_IPHONE8          ${MLogo}
    Run Keyword If      '${use mobile galaxy s8}' == '${platform}'    ANDROID_GALAXYS8     ${MLogo}

LOCALHOST
    [Arguments]     ${Logo}
    Set Suite Variable    ${testPlatform}    OS
    Set Suite Variable    ${Applitools-TestName}      DesktopE2E
...
IOS_IPHONE8
    [Arguments]     ${Logo}
    Set Suite Variable    ${testPlatform}    Mobile
#    Set Suite Variable    ${Applitools-TestName}      MobileE2E
